...
public class ADMDAO {
    public List<Vw_TelefonesPsicologos> ReadTelefonesPsicologos() {
        ...
        try {
            stmt = con.prepareStatement("SELECT CodigoPsicologo, Psicologo, Email,CRP, GROUP_CONCAT(numero) as Numero FROM vw_TelefonesPsicologos Group By CodigoPsicologo") ;
     ...
     public List<Vw_TelefonesPsicologos> BuscaManterPsicologo(String Atributo, String Busca) {
        ...
        List<Vw_TelefonesPsicologos> vw = new ArrayList<>();
        try {
            String sql = "SELECT CodigoPsicologo, Psicologo, Email,CRP, GROUP_CONCAT(numero) as Telefone FROM vw_TelefonesPsicologos WHERE "+Atributo+ " Like '%"+Busca+"%' Group By CodigoPsicologo;";
