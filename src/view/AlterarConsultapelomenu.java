 ...
 * @author User
 */
public class AlterarConsultapelomenu extends javax.swing.JFrame {
     ...
     */
    public AlterarConsultapelomenu() {
        initComponents();
...
//        tp.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlterarConsultapelomenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlterarConsultapelomenu().setVisible(true);
            }
        });
    }
