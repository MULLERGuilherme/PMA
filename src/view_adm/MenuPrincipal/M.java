...
public class M extends javax.swing.JFrame {
    ...
    public void getCount() {
        ...
        if (JCBdeletados.getSelectedIndex() == 1) {
            tableRowCount = dao.getRowCountTableManterPacientesAdm();
        } else {
    ...
    public void getCountBusca(String Busca) {
        ...
        if (JCBdeletados.getSelectedIndex() == 0) {
            ...
            tableRowCount = dao.getRowCountTableManterPacientesAdmBusca(Busca);
        }
    ...
    private void initComponents() {
        ...
        jLabel87.setText("Como Excluir um Paciente?");
        ...
        jLabel20.setText("da exclusão do paciente, confirmando a exclusão o paciente será deletado. Se você deletou um paciente por en");
        ...
        jLabel45.setText("apenas os pacientes excluídos, ao escolher apenas os excluídos e selecionar um dos pacientes da tabela, é possí");

        jLabel46.setText("vel clicar no botão restaurar para que o paciente volte a ficar ativo.");
                ...
                .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel13Layout.createSequentialGroup()
                        .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jLabel45, javax.swing.GroupLayout.PREFERRED_SIZE, 544, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        PainelMeusDadosLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, PainelMeusDadosLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel17, javax.swing.GroupLayout.DEFAULT_SIZE, 336, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jLabel18, javax.swing.GroupLayout.DEFAULT_SIZE, 992, Short.MAX_VALUE)
                .addContainerGap())
        );
...
//    }
    public void ReadJTablePag(int start, int size) {
        ...
        if (JCBdeletados.getSelectedIndex() == 0) {
            ...
            for (Vw_TelefonesPacientes vw : vwdao.fetchBySizeMPAdm(start, size)) {
                fones = vw.getTelefone().getNumero();
                if (fones.contains(",")) {
...
//    }
    public void ReadJTableBuscaPag(String Busca, int startrow, int size) {
        ...
        if (JCBdeletados.getSelectedIndex() == 0) {
            ...
            for (Vw_TelefonesPacientes vw : vwdao.fetchBySizeBuscaMPAdm(startrow, size, Busca)) {
                fones = vw.getTelefone().getNumero();
                if (fones.contains(",")) {
...
//        
    ...
    private void btnRestaurarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRestaurarActionPerformed
        ...
        if (JTPacientes.getSelectedRow() != -1) {
            ...
            PacienteDAO dao = new PacienteDAO();
            ViewsDAO vwdao = new ViewsDAO();
            Paciente p = dao.ReadPaciente(value);
            p.setCodPaciente(value);
            if (JCBdeletados.getSelectedIndex() == 1) {
                p.setDeletado(false);
            }
