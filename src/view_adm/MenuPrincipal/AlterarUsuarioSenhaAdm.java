 ...
 * @author User
 */
public class AlterarUsuarioSenhaAdm extends javax.swing.JFrame {
    ...
    private void BtnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAlterarActionPerformed
        ...
        if (!Validar.vCamposVaziosPSI(this, txtUsuario, txtSenha, txtConfirmarSenha)) {
            ...
            if (senha.equals(csenha)) {
                p.setSenha(senha);
                p.setCodPsicologo(AlterarUsuarioSenhaAdm.CodPsicologo);
                ...
                if (result == 0) {
                    ...
                    VisuPsicologoADM mp = new VisuPsicologoADM(CodPsicologo);
                    //Util.SizeJanela(mp);
                    mp.setVisible(true);
                    this.dispose();
                }
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlterarUsuarioSenhaAdm.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlterarUsuarioSenhaAdm().setVisible(true);
            }
        });
    }
