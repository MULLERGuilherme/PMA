...
//        BtnManterPaciente.setEnabled(false);
    ...
    private void initComponents() {
        ...
        jLabel84.setText("Como Editar os dados de um Psicólogo?");

        jLabel85.setText("Clicando no Botão \"Novo\" será aberta uma janela para que você possa inserir os dados do psicólogo, quando termi-");

        jLabel86.setText("nar de inserir os dados é só clicar no botão \"Cadastrar\" que o novo psicólogo terá seu cadastro realizado.");

        jLabel87.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel87.setText("Como Excluir um Psicólogo?");
        ...
        jLabel89.setText("para que possam ser editados os dados do psicólgo selecionado, quando terminar as alterações, é só clicar no");
        ...
        jLabel92.setText("Como Cadastrar um Psicólogo?");

        jLabel19.setText("Selecionando um psicólogo na tabela e apertando o botão \"Excluir\", será aberta uma janela pedindo a confirmação");

        jLabel20.setText("da exclusão do psicólogo, confirmando a exclusão o paciente será deletado. Se você deletou um psicólogo por enga");

        jLabel43.setText("no, ainda é possível restaurá-lo.");

        jLabel93.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel93.setText("Como Restaurar um Psicólogo?");

        jLabel44.setText("Acima da tabela de pacientes, a esquerda, é possível escolher se deseja visualizar apenas os psicólogos ativos ou");

        jLabel45.setText("apenas os psicólogos excluídos, ao escolher apenas os excluídos e selecionar um dos psicólogos da tabela, é pos");

        jLabel46.setText("sível clicar no botão restaurar para que o psicólogo volte a ficar ativo.");
        ...
        JTPsicologos.getTableHeader().setReorderingAllowed(false);
...
//        
    ...
    private void BtnCadastrarPsicologoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCadastrarPsicologoActionPerformed
        ...
        if ((String) txtCrp.getValue() != null) {
            crp = (String) txtCrp.getValue();
            crp = crp.replace("/", "");
        }
        if (txtSenha.getText().equals(txtConfirmarSenha.getText())) {
            if (!Validar.vCamposVaziosPSI(null, txtNome1, txtEmail1, crp, txtLogin, txtSenha, TxtTelefone1)) {
